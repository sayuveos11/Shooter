...
rocket_x, rocket_y = fighter_x + fighter_width / 2 - rocket_width / 2, fighter_y -fighter_height
...
while game_is_running:
    ...
    if (rocket_was_fired and
            alien_x < rocket_x < alien_x + alien_width - rocket_width
            and alien_y < rocket_y < alien_y + alien_height - rocket_height):
        rocket_was_fired: False
        alien_x, alien_y = randint(0, screen_width - alien_width), 0
